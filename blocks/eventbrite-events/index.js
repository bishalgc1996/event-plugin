 ...
 */
registerBlockType("ed-block/events", {
  // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
  title: __("Events Slider"),
  description: __("Block for Display  Events Slider"),
  icon: {
    foreground: "#f5662e",
    src: (
      <svg
      ...
      >
        ...
        >
          <path
            d="M4590 9989 c-942 -81 -1818 -411 -2565 -964 -378 -280 -770 -672
  ...
  category: "widgets",
  keywords: [__("Events"), __("Eventbrite"), __("eventbrite events")],
