...
<div class="col card-event">
  <div class="card-wrap">
    <div class="img-wrap">
      ...
      <a href="<?php echo $event_url; ?>"><img src="<?php echo ED_PLUGIN_URL . 'assets/images/dummy-event.png'; ?>"
...
if ($link_text) {
      ...
      <a href="javascript(;) " class="read-more" data-fancybox data-src="#team<?php echo $counter1; ?>">More info</a>
      <?php
}
    if ($button_text) {
