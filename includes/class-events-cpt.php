...
class Events_Cpt
{
    ...
    public function register_event_post_type()
    {
         ...
         */
        $event_labels = array(
            'name' => _x('Events', 'Post Type General Name', 'import-events'),
            'singular_name' => _x('Event', 'Post Type Singular Name', 'import-events'),
            'menu_name' => __(' Events', 'import-events'),
            'name_admin_bar' => __(' Event', 'import-events'),
            'archives' => __('Event Archives', 'import-events'),
            'parent_item_colon' => __('Parent Event:', 'import-events'),
            'all_items' => __(' Events', 'import-events'),
            'add_new_item' => __('Add New Event', 'import-events'),
            'add_new' => __('Add New', 'import-events'),
            'new_item' => __('New Event', 'import-events'),
            'edit_item' => __('Edit Event', 'import-events'),
            'update_item' => __('Update Event', 'import-events'),
            'view_item' => __('View Event', 'import-events'),
            'search_items' => __('Search Event', 'import-events'),
            'not_found' => __('Not found', 'import-events'),
            'not_found_in_trash' => __('Not found in Trash', 'import-events'),
            'featured_image' => __('Featured Image', 'import-events'),
            'set_featured_image' => __('Set featured image', 'import-events'),
            'remove_featured_image' => __('Remove featured image', 'import-events'),
            'use_featured_image' => __('Use as featured image', 'import-events'),
            'insert_into_item' => __('Insert into Event', 'import-events'),
            'uploaded_to_this_item' => __('Uploaded to this Event', 'import-events'),
            'items_list' => __('Event Items list', 'import-events'),
            'items_list_navigation' => __('Event Items list navigation', 'import-events'),
            'filter_items_list' => __('Filter Event items list', 'import-events'),
        );
        $rewrite = array(
        ...
        $event_cpt_args = array(
            'label' => __('Events', 'import-events'),
            'description' => __('Post type for Events', 'import-events'),
            'labels' => $event_labels,
    ...
    public function register_event_taxonomy()
    {
        ...
        register_taxonomy(
            $this->event_category, array($this->event_posttype), array(
                'labels' => array(
                    'name' => __('Event Types', 'import-events'),
                    'singular_name' => __('Event Type', 'import-events'),
                    'menu_name' => __('Event Types', 'import-events'),
                    'name_admin_bar' => __('Event Type', 'import-events'),
                    'search_items' => __('Search Types', 'import-events'),
                    'popular_items' => __('Popular Types', 'import-events'),
                    'all_items' => __('All Types', 'import-events'),
                    'edit_item' => __('Edit Type', 'import-events'),
                    'view_item' => __('View Type', 'import-events'),
                    'update_item' => __('Update Type', 'import-events'),
                    'add_new_item' => __('Add New Type', 'import-events'),
                    'new_item_name' => __('New Type Name', 'import-events'),
                ),
                'public' => true,
                'show_ui' => true,
                'show_in_nav_menus' => true,
        ...
        register_taxonomy(
            ...
            array(
                ...
                'labels' => array(
                    'name' => __('Event Tags', 'import-events'),
                    'singular_name' => __('Event Tag', 'import-events'),
                    'menu_name' => __('Event Tags', 'import-events'),
                    'name_admin_bar' => __('Event Tag', 'import-events'),
                    'search_items' => __('Search Tags', 'import-events'),
                    'popular_items' => __('Popular Tags', 'import-events'),
                    'all_items' => __('All Tags', 'import-events'),
                    'edit_item' => __('Edit Tag', 'import-events'),
                    'view_item' => __('View Tag', 'import-events'),
                    'update_item' => __('Update Tag', 'import-events'),
                    'add_new_item' => __('Add New Tag', 'import-events'),
                    'new_item_name' => __('New Tag Name', 'import-events'),
                    'separate_items_with_commas' => __('Separate tags with commas', 'import-events'),
                    'add_or_remove_items' => __('Add or remove tags', 'import-events'),
                    'choose_from_most_used' => __('Choose from the most used tags', 'import-events'),
                    'not_found' => __('No tags found', 'import-events'),
                    'parent_item' => null,
    ...
    public function add_event_meta_boxes()
    {
        add_meta_box(
            'events_metabox',
            __('Events Details', 'import-events'),
